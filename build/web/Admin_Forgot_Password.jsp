...
.ancher{
    ...
    <body>
        <form action='Servlet_Admin_Forgot_Password' method="post">
        <div class="container">
	...
	border: solid"type='number' name='txt_OTP'onkeypress='javascript:return isContactno(event)'/><br>
        ...
        <input class="btn" style="width:25%;"type="button" value="Cansel" onclick="window.window.location.href='Admin_login.jsp'"/>
        </div>
