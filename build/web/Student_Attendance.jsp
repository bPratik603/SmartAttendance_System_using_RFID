...
table td{
    ...
    <body>
        ...
        <input type="button" class='btn2' value="Back" onclick="window.window.location.href='Admin_Select_Student_Attendance.jsp'"/><br>
      ...
      try
      {
           ...
           String sql="Select * from attendance where Branch='"+session.getAttribute("Branch")+"' and year='"+session.getAttribute("Year")+"' and division='"+session.getAttribute("Division")+"'";
           ...
           while(rs.next())
           {
               ...
               <tr>
                   ...
                   <td> <input type="text" name="txt_S_Contact" value="<%=rs.getString("Date")%>"/> </td>
                   <td> <input type="text" name="txt_S_Contact" value="<%=rs.getString("In_Time")%>"/> </td>
                   <td> <input type="text" name="txt_S_Contact" value="<%=rs.getString("Status")%>"/> </td>
