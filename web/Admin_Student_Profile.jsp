...
<f%@page import="java.sql.DriverManager"%>
...
.btn:hover{
    ...
    <body>
      ...
      try
      {
           ...
           String sql="Select * from Student_Signup where Student_Signup_id='"+request.getParameter("txt_id")+"'";
    ...
    <div class="col"><input type="text" name="txt_Division" value="<%=rs.getString("Division")%>"/></div>
      ...
      %>
        ...
        <input type="button" class='btn' name='btn'value="BACK" onclick="window.window.location.href='Admin_view_Student_Details.jsp'">
