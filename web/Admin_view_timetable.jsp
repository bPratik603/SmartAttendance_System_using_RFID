...
.btn2:hover{
    ...
    <body>
        <div class="Title">
        <h1 style="margin-top: 0px;padding-top: 10px"><b>Time Table</b></h1>
        </div>
        <input type="button" class='btn2' value="Back" onclick="window.window.location.href='Admin_Choose_Time_Table.jsp'"><br>
      ...
      try
      {
           ...
           String sql="Select * from add_timetable where branch='"+session.getAttribute("Branch")+"' and year='"+session.getAttribute("Year")+"' and division='"+session.getAttribute("Division")+"'";
