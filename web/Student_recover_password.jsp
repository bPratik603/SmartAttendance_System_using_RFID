...
<html>
    <head>
        ...
        <title>Student_recover_password</title>
        <style>
            *{
	padding: 0;
	margin: 0;
...
.ancher{
    ...
    <body>
        <form action='Servlet_Student_Recover_Password' method="post">
        <div class="container">
        ...
        <input type="password" name='txt_N_Password'class='form-control'/><br>
        <label>Confirm Password: </label>
        <input type="password" name='txt_O_Password'class='form-control'/><br>
